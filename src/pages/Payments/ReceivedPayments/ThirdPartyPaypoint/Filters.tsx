...
import { thirdPartyPaypointFilterFormInitialData } from '../schemas';
...
const Filters: React.FC<IProps> = ({
  ...
  const handleRegionChange = (
    ...
    values: typeof thirdPartyPaypointFilterFormInitialData
  ) => {
    if (selectedOption) {
  ...
  return (
    ...
    >
      <Formik
        enableReinitialize
        initialValues={thirdPartyPaypointFilterFormInitialData}
        onSubmit={values => {
        ...
        {({ setFieldValue, values }) => (
          <Form className={classes.filterForm}>
            <Box display={{ sm: 'block', md: 'flex' }}>
              ...
              <Button fullWidth={matches} type="submit" variant="outlined" size="small" startIcon={<FilterIcon />}>
                {t('common:filters')}
              </Button>
            </Box>
          </Form>

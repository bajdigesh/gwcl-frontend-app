...
import { paymentsFilterFormData } from './schema';
...
const Filters: React.FC<IProps> = ({
  ...
  const sortByDropdownOption = [
    { label: t('customers:firstPaid'), value: sortingOrder.ASCENDING },
    { label: t('customers:lastPaid'), value: sortingOrder.DESCENDING },
  ];
  ...
  return (
    ...
    >
      <Formik
        enableReinitialize
        initialValues={paymentsFilterFormData}
        onSubmit={values => {

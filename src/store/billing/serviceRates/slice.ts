...
const namespace = 'billing/serviceRates';
...
const initialState: Record<string, ISliceState<any>> = {
  getServiceRatesState: commonInitialState,
  getServiceRatesByServiceAgreementState: commonInitialState,
  getServiceRatesHistoriesByServiceAgreeementIdState: commonInitialState,
  saveServiceRateState: commonInitialState,
};

// Slice
const serviceRates = createSlice({
  name: namespace,
...
export const {} = serviceRates.actions;
export default serviceRates.reducer;

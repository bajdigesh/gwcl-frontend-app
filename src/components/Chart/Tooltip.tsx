...
export const createTooltipElement = (tooltipClass?: string): HTMLElement => {
...
export const toggleTooltip = (tooltipModel: any, tooltipEl: HTMLElement) => {
...
export const configureTooltipPosition = (context: any, tooltipEl: HTMLElement, offsetDistance?: number) => {
